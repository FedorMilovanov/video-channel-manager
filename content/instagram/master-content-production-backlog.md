...
1. subject and project identity are exact;
2. every factual claim maps to a bound project source;
3. degree of certainty matches the source;
4. direct quote has exact edition/span evidence;
