...
def trust_block() -> str:
    return "\n".join(
        (
            ...
            "У Виктории 5 лет опыта, а каждый торт или десерт создаётся вручную под конкретный заказ.",
            "В обучении Виктории — авторские и детские торты, акварельная роспись по мастике и барельеф, "
            "шоколадная флористика. Сертификаты собраны на отдельной странице сайта.",
