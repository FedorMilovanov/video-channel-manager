...
def _wall_item(index: int, *, post_id: int | None = None, extra_photo_id: int | None = None) -> dict[str, Any]:
...
def _snapshot(
    *,
    ...
    return build_wall_snapshot(
        ...
        published_items=[_wall_item(0, post_id=first_post_id, extra_photo_id=extra_photo_id)],
