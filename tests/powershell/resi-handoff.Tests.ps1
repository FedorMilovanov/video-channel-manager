Describe "Resi/DASH generated handoff" {
    ...
    It "executes download, exact trim, receipts, and offline-safe master reuse with provider-free tool doubles" {
        ...
        $Url = "https://resi.media/GiHDtf/9aa9ac24-fb79-4ca9-95ef-a3253afdf63f/Manifest.mpd?src=emb"
        $global:ResiFakeInspectCount = 0
        $global:ResiFakeDownloadCount = 0
        $global:ResiFakeTrimCount = 0

        function global:yt-dlp {
            if ($args -contains "-F") {
                $global:ResiFakeInspectCount += 1
            ...
            $global:ResiFakeDownloadCount += 1
            $global:LASTEXITCODE = 0
        }
...
"@
        ...
        try {
            ...
            $global:ResiFakeInspectCount | Should -Be 1
            $global:ResiFakeDownloadCount | Should -Be 1
            $global:ResiFakeTrimCount | Should -Be 1
            ...
            $global:ResiFakeInspectCount | Should -Be 1
            $global:ResiFakeDownloadCount | Should -Be 1
            $global:ResiFakeTrimCount | Should -Be 2
        }
        finally {
            Remove-Item -Path Function:\global:yt-dlp -ErrorAction SilentlyContinue
            Remove-Item -Path Function:\global:ffprobe -ErrorAction SilentlyContinue
            Remove-Item -Path Function:\global:ffmpeg -ErrorAction SilentlyContinue
            Remove-Variable -Name ResiFakeInspectCount -Scope Global -ErrorAction SilentlyContinue
            Remove-Variable -Name ResiFakeDownloadCount -Scope Global -ErrorAction SilentlyContinue
            Remove-Variable -Name ResiFakeTrimCount -Scope Global -ErrorAction SilentlyContinue
        }
    }
}
