...
`milovi-feed-20260819-001`, unauthorized `milovi-feed-20260820-001`, and authorized-but-undispatched `milovi-feed-20260820-002` are immutable stale history and must not be caught up, retimed or reinterpreted as successors. Do not publish, retime or catch up `milovi-feed-20260820-002`. The current exact publication is `milovi-feed-20260821-001` at `2026-08-21T10:30:00+03:00` (marathon position 1, `p06`). Fresh human authorization set `release_authorized=true` and `execution_authorized=true` for that identity only. Dispatch is due only in the 10:30–12:30 Europe/Moscow freshness window through the permanent writer; no other Milovi identity is authorized. Durable feed state is not initialized until `initialize-state`.
...
3. Do not catch up `milovi-feed-20260819-001`, `milovi-feed-20260820-001` or `milovi-feed-20260820-002`. `milovi-feed-20260821-001` is the only currently authorized Milovi identity; initialize state, then publish once in its 10:30–12:30 freshness window. No other Milovi publication is authorized.
