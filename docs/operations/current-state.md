...
`milovi-feed-20260819-001`, unauthorized `milovi-feed-20260820-001`, and authorized-but-undispatched `milovi-feed-20260820-002` are immutable stale history and must not be caught up, retimed or reinterpreted as successors. Do not publish, retime or catch up `milovi-feed-20260820-002`. The current exact candidate is `milovi-feed-20260821-001`, scheduled for `2026-08-21T10:30:00+03:00`: marathon position 1, media `p06`, same reviewed JPEG transport, public caption tightened without new claims. Its runtime remains `release_authorized=false`, execution authority remains `execution_authorized=false`, and `provider_mutation_allowed=false`. Durable feed state is not initialized. This document does not authorize dispatch.
...
3. Do not catch up `milovi-feed-20260819-001`, `milovi-feed-20260820-001` or `milovi-feed-20260820-002`. Keep `milovi-feed-20260821-001` provider-inert until separate exact release authorization and separate fresh exact human execution authorization; this document creates neither.
